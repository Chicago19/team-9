    ...
    return (
      <Container className='wrap purple-box shadow'>
        ...
        <span className = 'icon-settings'>
          <div><FontAwesomeIcon icon={this.props.icon === 'gamepad' ? faGamepad : this.props.icon === 'calendar' ? faCalendarAlt : this.props.icon === 'child' ? faChild : faUserFriends} /></div></span></span>
          { linkFront === 'http' ? (
